...
var componentTypeWithRefs = createChainableTypeChecker(function (props, propName, componentName, location, propFullName) {
  ...
  if (! /*#__PURE__*/React__default.isValidElement(propValue) && reactIs.isValidElementType(propValue)) {
    var ownProps = {
      ref: function ref() {},
      step: {}
    };
  ...
  _createClass(JoyrideBeacon, [{
    ...
    value: function render() {
      ...
      if (beaconComponent) {
        ...
        component = /*#__PURE__*/React__default.createElement("button", _extends({
          key: "JoyrideBeacon",
...
var JoyrideOverlay = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(JoyrideOverlay, [{
    ...
    value: function render() {
      ...
      var spotlight = placement !== 'center' && showSpotlight && /*#__PURE__*/React__default.createElement(JoyrideSpotlight, {
      ...
      if (getBrowser() === 'safari') {
        ...
        spotlight = /*#__PURE__*/React__default.createElement("div", {
  ...
  _createClass(JoyrideTooltipContainer, [{
    ...
    value: function render() {
      ...
      if (continuous) {
        ...
        if (showProgress) {
          output.primary = /*#__PURE__*/React__default.createElement("span", null, output.primary, " (", index + 1, "/", size, ")");
        }
      }

      if (showSkipButton && !isLastStep) {
        output.skip = /*#__PURE__*/React__default.createElement("button", _extends({
      ...
      if (!hideBackButton && index > 0) {
        output.back = /*#__PURE__*/React__default.createElement("button", _extends({
          style: styles.buttonBack,
          type: "button"
        }, backProps), back);
      }

      output.close = !hideCloseButton && /*#__PURE__*/React__default.createElement(JoyrideTooltipCloseBtn, _extends({
      ...
      }, content)), !hideFooter && /*#__PURE__*/React__default.createElement("div", {
        style: styles.tooltipFooter
      }, /*#__PURE__*/React__default.createElement("div", {
        style: styles.tooltipFooterSpacer
      }, output.skip), output.back, /*#__PURE__*/React__default.createElement("button", _extends({
  ...
  _createClass(JoyrideTooltip, [{
    ...
    value: function render() {
      ...
      if (tooltipComponent) {
        ...
        component = /*#__PURE__*/React__default.createElement(JoyrideTooltipContainer, _extends({}, this.getElementsProps(), {
          continuous: continuous,
          index: index,
          isLastStep: isLastStep,
          size: size,
...
var JoyrideStep = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(JoyrideStep, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
      ...
      }, /*#__PURE__*/React__default.createElement(JoyridePortal, {
        id: "react-joyride-portal"
      }, /*#__PURE__*/React__default.createElement(JoyrideOverlay, _extends({}, step, {
        debug: debug,
        lifecycle: lifecycle,
        onClickOverlay: this.handleClickOverlay
      }))), /*#__PURE__*/React__default.createElement(Floater, _extends({
        ...
        target: step.target
      }, step.floaterProps), /*#__PURE__*/React__default.createElement(JoyrideBeacon, {
  ...
  _createClass(Joyride, [{
    ...
    value: function render() {
      ...
      if (status === STATUS.RUNNING && step) {
        output = /*#__PURE__*/React__default.createElement(JoyrideStep, _extends({}, this.state, {
